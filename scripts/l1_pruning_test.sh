...
echo "Starting L1 0.05"
echo run_python_command
run_python_command "L1 0.05" 0.05
echo "Finished L1 0.01"

echo "Starting L1 0.1"
echo run_python_command
run_python_command "L1 0.1" 0.1
echo "Finished L1 0.1"

echo "Starting L1 0.3"
echo run_python_command
run_python_command "L1 0.3" 0.3
echo "Finished L1 0.3"

echo "Starting L1 0.5"
echo run_python_command
run_python_command "L1 0.5" 0.5
